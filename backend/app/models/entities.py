...
class Organizacion(Base):
    ...
    clientes: Mapped[List["Cliente"]] = relationship(back_populates="organizacion")


class Cliente(Base):
    """Cliente, carpeta o grupo usado para separar radicados y reportes."""
    ...
    organizacion: Mapped[Optional[Organizacion]] = relationship(back_populates="clientes")

    __table_args__ = (Index("ix_clientes_org_nombre", "organizacion_id", "nombre", unique=True),)
